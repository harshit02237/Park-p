        ...
        <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between border-b border-[#efd9bd] pb-8">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 text-xs font-bold text-[#765f55]">
              <span className="flex items-center gap-1 rounded-xl border border-[#efd9bd] bg-[#fff8ed] px-3 py-1.5">
                <ShoppingBag className="h-3.5 w-3.5 text-[#d9472b]" /> Cash on Delivery
              </span>
              <span className="flex items-center gap-1 rounded-xl border border-[#efd9bd] bg-[#fff8ed] px-3 py-1.5">
                <QrCode className="h-3.5 w-3.5 text-[#d9472b]" /> UPI & QR Scan
              </span>
              <span className="flex items-center gap-1 rounded-xl border border-[#efd9bd] bg-[#fff8ed] px-3 py-1.5">
                <CreditCard className="h-3.5 w-3.5 text-[#d9472b]" /> Credit / Debit Card
              </span>
            </div>
          </div>
        </div>
